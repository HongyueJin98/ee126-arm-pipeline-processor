...
architecture structure of PipelinedCPU0 is
...
ExMem_Addin, ExMem_Aluresult, ExMem_RD2, ReadData, MemWb_Aluresult, MemWb_RD, IdEx_signextend,IfId_pc_out:STD_LOGIC_VECTOR(63 downto 0);
...
IdEx_ALUSrc,IdEx_RegWrite,IdEx_UBranch, zero, overflow, ExMem_CBranch,ExMem_MemRead, ExMem_MemtoReg,ExMem_MemWrite,
...
U5: IfId port map(clk=>clk,IfId_instr_in=>PCout,IfId_pc_in=>PCAddressOut,IfId_instr_out=>IfId_instr_out,IfId_pc_out=>IfId_pc_out);   --IfId
...
U9: CPUControl port map(Opcode=>IfId_instr_out(31 downto 21),CBranch=>CBranch,MemRead=>MemRead,MemWrite=>MemWrite,ALUSrc=>ALUSrc,RegWrite=>RegWrite,UBranch=>UBranch,ALUOp=>ALUOp,MemtoReg=>MemtoReg);   --control

U10: IdEx port map(clk=>clk,IdEx_CBranch_in=>CBranch,IdEx_MemRead_in=>MemRead,IdEx_MemtoReg_in=>MemtoReg,IdEx_MemWrite_in=>MemWrite,
...
U13: MUX64 port map(in0=>IdEx_RD2,in1=>IdEx_signextend,sel=>IdEx_ALUSrc,output=>ALUin);   --mux for ALU
...
U16: ExMem port map(clk=>clk, ExMem_CBranch_in=>IdEx_CBranch,ExMem_MemRead_in=>IdEx_MemRead,ExMem_MemtoReg_in=>IdEx_MemtoReg,
ExMem_MemWrite_in=>IdEx_MemWrite, ExMem_RegWrite_in=>IdEx_RegWrite,ExMem_UBranch_in=>IdEx_UBranch,ExMem_Addin_in=>Sadd_output,
ExMem_Zero_in=>zero, ExMem_Aluresult_in=>ALUresult,ExMem_RD2_in=>IdEx_RD2,ExMem_instr5_in=>IdEx_instr5, 
...
ExMem_RD2=>ExMem_RD2,ExMem_instr5=>ExMem_instr5);   --ExMem
...
U19: MemWb port map(clk=>clk, MemWb_instr5_in=>ExMem_instr5,MemWb_RD=>MemWb_RD, MemWb_MemWtoReg_in=>ExMem_MemtoReg,
