...
U10: IdEx port map(IdEx_rst=>branch,IdEx_sturinstruct_in=>IfId_instruction_out(31 downto 21),IdEx_sturinstruct_out =>IdEx_sturinstruct_out , IdEx_Rn_in=>IfId_instruction_out(9 downto 5),IdEx_Rm_in=>IfId_instruction_out(20 downto 16),IdEx_Rd_in=>IfId_instruction_out(4 downto 0),IdEx_Rn_out=>IdEx_Rn_out,IdEx_Rm_out=>IdEx_Rm_out,IdEx_Rd_out=>IdEx_Rd_out,clk=>clk,IdEx_Reg2Loc_in=>Reg2Loc,IdEx_CBranch_in=>CBranch,IdEx_MemRead_in=>MemRead,IdEx_MemtoReg_in=>MemtoReg,IdEx_MemWrite_in=>MemWrite,
...
U16: ExMem port map(ExMem_rst=>branch,ExMem_Rd_out=>ExMem_Rd_out,ExMem_Rd_in=>IdEx_Rd_out,clk=>clk,ExMem_Reg2Loc_in=>IdEx_Reg2Loc,ExMem_CBranch_in=>IdEx_CBranch,
...
U18: MemWb port map(MemWb_rst=>branch,MemWb_Rd_in1=>ExMem_Rd_out, MemWb_Rd_out=>MemWb_Rd_out,clk=>clk, MemWb_instruction5_in=>ExMem_instruction5, MemWb_MemWtoReg_in=>ExMem_MemtoReg,
