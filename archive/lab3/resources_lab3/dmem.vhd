...
generic(NUM_BYTES : integer := 1024); --changed as initializing the dmem to 1KB
...
begin
   ...
   -- you can add debugging signals here
    ...
    DEBUG_MEM_CONTENTS <=
       ...
       dmemBytes(1020) & dmemBytes(1021) & dmemBytes(1022) & dmemBytes(1023);  --DMEM(1020)
	--make sure that all memory unit in the component could work
